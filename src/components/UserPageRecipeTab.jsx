...
const UserPageRecipeTab = () => {
  return (
    <div className='p-6'>
      <div>
        <div className='grid grid-cols-2 p-6 gap-x-4 gap-y-4'>
          ...
          <div className='shadow-lg bg-platinum  hover:bg-sandybrown hover:text-platinum flex col-span-2 min-w-[150px] h-14 rounded-lg justify-center items-center text-center'>
            <h1>Saved Recipes</h1>
          </div>
        </div>
        <RecipePlaceholder/>
