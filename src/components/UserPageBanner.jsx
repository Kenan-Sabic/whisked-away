...
const UserPageBanner = () => {
  return (
    <div className='flex flex-col md:flex-row bg-platinum w-full h-[40vh] items-center md:items-start'>
          ...
          <div className='shadow-md max-w-[300px] max-h-[80px] bg-lightorange rounded-md p-4 px-16 mt-10 md:ml-[100px] md:mr-[150px] font-bold flex items-center'>
             <h1>Edit Profile</h1>
            </div>
        </div>
  )
