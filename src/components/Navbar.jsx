...
const Navbar = () => {
	...
	return (
      ...
      font-Lato text-3xl font-medium text-white'
			>
				<div className='flex'>
					<img src={home} className='m-3 h-14 w-14 cursor-pointer lg:ml-10 ' onClick={handleClick}></img>
					<a className='mt-5 hidden cursor-pointer sm:block' onClick={handleClick}>
						Home
					</a>
				</div>
				<div className='mr-5 flex justify-self-end'>
					...
					></img>
					<a className='mt-5 hidden cursor-pointer sm:block' onClick={handleProfileClick}>
						{!token ? 'Login' : 'Profile'}
					</a>
				</div>
			</div>
