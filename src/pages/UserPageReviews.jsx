  ...
  return (
    <div className="bg-neutral-100">
      ...
      <div className="w-full md:grid md:grid-cols-10">
        ...
        <div className="flex  w-full flex-col items-center rounded-md border border-dashed border-sandybrown bg-neutral-50 text-center shadow-2xl md:col-start-4 md:col-end-11 md:mt-[-170px]">
          ...
          <div className="m-5 mb-10 w-full bg-neutral-50">
            <UserPageReviewTab />
          </div>
        </div>
      </div>
