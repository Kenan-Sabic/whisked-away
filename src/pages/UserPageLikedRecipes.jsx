...
import UserPageLikedRecipesTab from '../components/UserPageLikedRecipesTab';
import Footer from '../components/Footer';
const UserPageLikedRecipes = () => {
	return (
...
export default UserPageLikedRecipes;
